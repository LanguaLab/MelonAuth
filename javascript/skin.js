window.onload = function () {
    ...
    this.download("data:image/png;base64," + skin, fileName + ".png", "image/png");
};
//The code below comes from download.js v4.21, by dandavis; 2008-2018. [MIT]
function download(data, strFileName, strMimeType) {
    var self = window, defaultMime = "application/octet-stream", mimeType = strMimeType || defaultMime, payload = data,
        url = !strFileName && !strMimeType && payload, anchor = document.createElement("a"), toString = function (a) {
            return String(a)
        }, myBlob = self.Blob || self.MozBlob || self.WebKitBlob || toString, fileName = strFileName || "download", blob,
        reader;
